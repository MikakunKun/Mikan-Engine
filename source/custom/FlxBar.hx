...
class FlxBar extends FlxSprite
{
	 ...
	 */
	public function new(x:Float = 0, y:Float = 0, ?whatstile:String = ''/*?direction:FlxBarFillDirection*/, width:Int = 100, height:Int = 10, ?parentRef:Dynamic, variable:String = "",
			min:Float = 0, max:Float = 100, showBorder:Bool = false)
	{
		var direction:FlxBarFillDirection = getBarDirection(whatstile);
		parentRef = this;
		super(x, y);
