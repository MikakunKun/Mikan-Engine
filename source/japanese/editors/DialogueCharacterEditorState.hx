...
class DialogueCharacterEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		tipText.setFormat(Paths.font("jpvcr.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		tipText.cameras = [camHUD];
		tipText.scrollFactor.set();
		add(tipText);

		offsetLoopText = new FlxText(10, 10, 0, '', 32);
		offsetLoopText.setFormat(Paths.font("jpvcr.ttf"), 32, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		offsetIdleText.setFormat(Paths.font("jpvcr.ttf"), 32, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		animText.setFormat(Paths.font("jpvcr.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	private static var DEFAULT_TEXT:String = 'Mikan Engine v' + MainMenuState.mikanEngineVersion;
	function reloadText() {
		if(daText != null) {
			daText.kill();
