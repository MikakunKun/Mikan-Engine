...
class DialogueEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		var addLineText:FlxText = new FlxText(10, 10, FlxG.width - 20, 'Oを押すと現在の台詞が削除され、Pを押すと現在の台詞の後にもう一行追加されます。', 8);
		addLineText.setFormat(Paths.font("jpvcr.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		addLineText.scrollFactor.set();
		add(addLineText);

		selectedText = new FlxText(10, 32, FlxG.width - 20, '', 8);
		selectedText.setFormat(Paths.font("jpvcr.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
