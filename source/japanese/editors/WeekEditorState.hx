...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		missingFileText.setFormat(Paths.font("jpvcr.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("jpvcr.ttf");
