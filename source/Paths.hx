...
class Paths
{
	...
	inline static public function voices(song:String, ?difficulty:String):Any
	{
		...
		if(difficulty != null)
		{
			var diffivoice = returnSound('songs', '$songKey-$difficulty');
			if(Assets.exists(diffivoice))
				return diffivoice;
		}
		*/
		return voices;
	...
	inline static public function dadvoices(song:String, ?chara:String):Any
	{
		var songKey:String = '${formatToSongPath(song)}/Voices-${formatToSongPath(chara)}';
		var dadvoices = returnSound('songs', songKey);
		return dadvoices;
	}

	inline static public function bfvoices(song:String, ?chara:String):Any
	{
		var songKey:String = '${formatToSongPath(song)}/Voices-${formatToSongPath(chara)}';
		var bfvoices = returnSound('songs', songKey);
		return bfvoices;
	}
