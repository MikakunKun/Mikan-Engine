...
typedef IconData =
{
	var anim:String;
	var name:String;
	var health_percent:Array<Float>;
}
...
class Character extends FlxPerspectiveSprite
{
	...
	public var iconDatas:Array<IconData>;
	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false, ?gf:Bool = true)
	{
		super(x, y);
