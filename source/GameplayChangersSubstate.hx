...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		var qoption:GameplayOption = new GameplayOption('Play Stail', 'playstail', 'string', 'bf', ["bf", "opponent", "player health both", "not player health both", "vs player health", "vs player score"]);
		...
		var moption:GameplayOption = new GameplayOption('Random Change Mania', 'RandomMania', 'string', 'false', ["false", "true"]);
		optionsArray.push(goption);

		var option:GameplayOption = new GameplayOption('Random Mania', 'RandomKeyCount', 'Int', 8);
		option.scrollSpeed = 1;
		option.minValue = 1;
